...
<body>
	...
	<h3>TU LIBRO NO SE PUEDE RESERVAR POR QUE ALCANZASTE EL MAXIMO DE LIBROS POR ALUMNO</h3>
	<h3>NO PODRAS RESERVAR HASTA DEVOLVER LOS LIBROS EN PRESTAMO O LOS LIBROS QUE TIENES RESERVADOS</h3>
	<br />
