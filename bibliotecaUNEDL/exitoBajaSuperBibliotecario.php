...
<head>
    ...
    <meta charset="UTF-8">
    <title>Página baja de bibliotecario exitoso</title>
	...
	<header>
		 <!--Header donde se encuentra el logo y los estilos-->
			...
			<div class="contenedor-form">
				...
				<br />
				<!--Contenido del body-->
				<h3>EL BIBLIOTECARIO SE DIO DE BAJA CON EXITO</h3>
				<br />
				...
				<br />
				<!--Boton para eliminar otro-->
				<div class="registroexitoso">
    			<h3>Eliminar otro bibliotecario.</h3>
    			</div>
				<div class="logo">
