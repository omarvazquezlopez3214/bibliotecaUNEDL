...
<head>
    ...
    <meta charset="UTF-8">
    <title>No exito alta de libro</title>
			 ...
			 <div class="cinta"></div>
				...
				<div class="contenedor-form">
					<div class="registroexitoso">
						<br />
						<!--Contenido del Body-->
						<h3>YA EXISTE EL IDENTIFICADOR (ID) QUE INGRESASTE, INGRESA OTRO</h3>
						<br />
						<h3>Regresar.</h3>
					</div>
					<br />
					<!--Boton para regresar a dar de alta-->
					<div class="logo">
						<a href="altalibrosuper.php"><img src="img/regresar.png" width="120" height="120" /></a>
					</div>
					<br />
    			</div>
</body>
